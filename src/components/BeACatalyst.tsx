...
import { Zap, Target, Award, Send } from 'lucide-react';
...
export const BeACatalyst: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-orange-50 via-red-50 to-purple-50 relative overflow-hidden">
      {/* Background Elements */}
          ...
          <ScrollReveal delay={300} direction="right">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mt-2">Ready to catalyze change? Let's discuss partnership opportunities.</p>
              </div>
