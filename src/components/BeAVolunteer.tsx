...
import { Users, Heart, BookOpen, Send } from 'lucide-react';
    ...
    <section className="py-24 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <img
          ...
          alt="Students volunteering and teaching"
          ...
          <ScrollReveal delay={300} direction="right">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Join Our Movement</h3>
                <p className="text-gray-600 mt-2">Ready to make a difference? Fill out the form below.</p>
              </div>
