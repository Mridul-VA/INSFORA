...
import { Handshake, Users, Globe, Send } from 'lucide-react';
          ...
          <ScrollReveal delay={300} direction="right">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Start Collaborating</h3>
                <p className="text-gray-600 mt-2">Let's work together to create meaningful impact.</p>
              </div>
